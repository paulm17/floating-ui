...
export default { title: 'React: FloatingArrow' };
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="flex justify-center">
            <TooltipWithArrow content="Settings and configuration options">
              <div className="w-12 h-12 bg-gray-600 rounded-full flex items-center justify-center cursor-pointer hover:bg-gray-700 transition-colors">
                <svg
          ...
          <div className="flex justify-center">
            <TooltipWithArrow content="This card contains important information that you should definitely read">
              <div className="bg-white p-4 rounded-lg shadow-md cursor-pointer hover:shadow-lg transition-shadow">
                ...
                <p className="text-gray-600 text-sm">Hover to see tooltip</p>
              </div>
            </TooltipWithArrow>
          </div>
          ...
          <div className="flex justify-center">
            <TooltipWithArrow content="This indicates the current status of the system">
              <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800 cursor-help">
                Active
              </span>
            </TooltipWithArrow>
          </div>
    ...
    <>
      ...
      <FloatingPortal>
        {isOpen && (
          ...
          >
            <ReactFloatingArrow ref={arrowRef} context={context} className="fill-gray-900" />
            {content}
          </div>
        )}
      </FloatingPortal>
